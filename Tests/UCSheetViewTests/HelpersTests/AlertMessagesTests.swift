...
final class AlertMessagesTests: XCTestCase {
  ...
  func testAlertMessages_InvalidDetentsWarning() {
    let expectedWarningMessage = "`detents` passed to UCSheetView.Configuration is empty. Default detents will be used but can result in unexpected behavior."
  ...
  func testAlertMessages_IdenticalDetentIdentifiersWarning() {
    let expectedWarningMessage = "`detents` passed to UCSheetView.Configuration contains multiple detents with the same identifier. `detents` must use unique identifiers. Any detent identified by a previously used identifier will be ignored."
  ...
  func testAlertMessages_InvalidDefaultDetentWarning() {
    let expectedWarningMessage = "`detents` passed to UCSheetView.Configuration does not contain a default detent. The default detent will be set to the smallest detent in the `detents` array after resolving heights."
  ...
  func testAlertMessages_InvalidLargestUnDimmedDetentIdentifierWarning() {
    let expectedWarningMessage = "`largestUnDimmedDetentIdentifier` is not contained in the `detents` passed to UCSheetView.Configuration. The specified `largestUnDimmedDetentIdentifier` will be ignored."
